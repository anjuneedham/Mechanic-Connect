...
window.MC_CONFIG = {
  /* Where the lead form posts. Replace with the real endpoint (a form service,
     a serverless function, or the client's own handler). Must accept a
     POST of application/x-www-form-urlencoded. */
  FORM_ENDPOINT: "https://example.invalid/REPLACE-WITH-YOUR-FORM-ENDPOINT",
