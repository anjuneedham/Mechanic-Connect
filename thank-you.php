...
<section class="sec">
  <div class="wrap">
    ...
    <div class="paths">
      ...
      <a class="pth" href="<?= store_url('customer') ?>"><img class="pth__ico" src="<?= BASE ?>/assets/img/app-customer.jpg" alt="" width="256" height="256" loading="lazy"><h3>Download the app</h3><p>Request service, compare quotes and pay securely.</p><span class="act"><?= store_cta('customer') ?></span></a>
    </div>
  </div>
</section>
